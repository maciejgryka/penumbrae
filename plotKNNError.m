...
%     [index, parameters] = flann_build_index(slices_shad, struct('algorithm', 'kdtree', 'trees', 2500));
...
%     [best_descrs_f dists_f] = flann_search(index,slices',k,parameters);
%     best_descrs_f = best_descrs_f';
%     dists_f = dists_f';
%     
