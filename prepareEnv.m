function [shad noshad matte penumbra_mask p_pix n_angles len n_descrs pixel] = prepareEnv(date, suffix)
    img_date = date;
    shad = imread(['C:\Work\research\shadow_removal\penumbrae\images\', img_date, '\', img_date, suffix, '_shad.tif']);
    noshad = imread(['C:\Work\research\shadow_removal\penumbrae\images\' img_date '\' img_date, suffix, '_noshad.tif']);
